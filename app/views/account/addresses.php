...
<div class="px-4 py-8 bg-gray-50">
  <div class="site-container">
    <div class="mb-6">
      <h1 class="text-2xl font-normal text-gray-800">Mes adresses</h1>
        ...
        <div class="grid grid-cols-1 gap-4 mb-6 sm:grid-cols-2">
          <?php if (empty($addresses)): ?>
            <div class="p-6 text-center bg-white border border-gray-200 rounded-lg col-span-full">
              ...
              <p class="text-gray-600">Vous n'avez pas encore enregistré d'adresse.</p>
            </div>
          <?php else: ?>
              ...
              <div class="p-5 bg-white border border-gray-200 rounded-lg shadow-sm">
                <div class="flex justify-between mb-3">
                  <h3 class="font-medium text-gray-800 text-md">
                    <?= htmlspecialchars($address['type']) === 'shipping' ? 'Adresse de livraison' : 'Adresse de facturation' ?>
                    <?= isset($address['is_default']) && $address['is_default'] ? ' (par défaut)' : '' ?>
                  </h3>
          ...
          <div class="p-5 text-center border border-gray-300 border-dashed rounded-lg bg-gray-50">
            <button type="button" onclick="openAddModal()" class="flex flex-col items-center justify-center w-full h-full text-gray-600 hover:text-red-600">
              ...
              <span class="text-sm font-medium">Ajouter une nouvelle adresse</span>
            </button>
          </div>
        </div>

        <div class="p-6 bg-white border border-gray-200 rounded-lg shadow-sm">
          <h2 class="mb-4 text-lg font-medium text-gray-800">Paramètres de livraison</h2>

          <div class="mb-4">
            <label class="flex items-center">
              <input type="checkbox" class="w-4 h-4 text-red-600 border-gray-300 rounded focus:ring-red-500" checked>
              <span class="ml-2 text-sm text-gray-700">Utiliser la même adresse pour la livraison et la facturation par défaut</span>
            </label>
          </div>

          <p class="text-sm text-gray-600">
            Ces préférences seront appliquées automatiquement lors de vos prochaines commandes.
            Vous pourrez toujours les modifier lors de la finalisation de votre achat.
          </p>
        </div>
      </div>
    </div>
...
<div id="addAddressModal" class="fixed inset-0 z-50 flex items-center justify-center hidden">
  ...
  <div class="relative z-10 w-full max-w-lg p-6 mx-4 bg-white rounded-lg shadow-xl">
    ...
    <h3 class="mb-4 text-lg font-medium text-gray-900">Ajouter une nouvelle adresse</h3>
    <form id="addAddressForm" action="/account/addresses/add" method="POST">
      <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
        <!-- Address Type -->
        <div class="sm:col-span-2">
          <label class="block mb-1 text-sm font-medium text-gray-700">Type d'adresse</label>
        ...
        <!-- First Name -->
        <div>
          <label for="add_first_name" class="block mb-1 text-sm font-medium text-gray-700">Prénom *</label>
        ...
        <!-- Last Name -->
        <div>
          <label for="add_last_name" class="block mb-1 text-sm font-medium text-gray-700">Nom *</label>
        ...
        <!-- Address Line 1 -->
        <div class="sm:col-span-2">
          <label for="add_address" class="block mb-1 text-sm font-medium text-gray-700">Adresse *</label>
        ...
        <!-- Address Line 2 -->
        <div class="sm:col-span-2">
          <label for="add_address2" class="block mb-1 text-sm font-medium text-gray-700">Complément d'adresse</label>
        ...
        <!-- Postal Code -->
        <div>
          <label for="add_postal_code" class="block mb-1 text-sm font-medium text-gray-700">Code postal *</label>
        ...
        <!-- City -->
        <div>
          <label for="add_city" class="block mb-1 text-sm font-medium text-gray-700">Ville *</label>
        ...
        <!-- Country -->
        <div>
          <label for="add_country" class="block mb-1 text-sm font-medium text-gray-700">Pays *</label>
        ...
        <!-- Phone -->
        <div>
          <label for="add_phone" class="block mb-1 text-sm font-medium text-gray-700">Téléphone *</label>
...
<div id="editAddressModal" class="fixed inset-0 z-50 flex items-center justify-center hidden">
  ...
  <div class="relative z-10 w-full max-w-lg p-6 mx-4 bg-white rounded-lg shadow-xl">
    ...
    <h3 class="mb-4 text-lg font-medium text-gray-900">Modifier l'adresse</h3>
    <form id="editAddressForm" action="/account/addresses/update" method="POST">
      ...
      <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
        ...
        <!-- First Name -->
        <div>
          <label for="edit_first_name" class="block mb-1 text-sm font-medium text-gray-700">Prénom *</label>
        ...
        <!-- Last Name -->
        <div>
          <label for="edit_last_name" class="block mb-1 text-sm font-medium text-gray-700">Nom *</label>
        ...
        <!-- Address Line 1 -->
        <div class="sm:col-span-2">
          <label for="edit_address" class="block mb-1 text-sm font-medium text-gray-700">Adresse *</label>
        ...
        <!-- Address Line 2 -->
        <div class="sm:col-span-2">
          <label for="edit_address2" class="block mb-1 text-sm font-medium text-gray-700">Complément d'adresse</label>
        ...
        <!-- Postal Code -->
        <div>
          <label for="edit_postal_code" class="block mb-1 text-sm font-medium text-gray-700">Code postal *</label>
        ...
        <!-- City -->
        <div>
          <label for="edit_city" class="block mb-1 text-sm font-medium text-gray-700">Ville *</label>
        ...
        <!-- Country -->
        <div>
          <label for="edit_country" class="block mb-1 text-sm font-medium text-gray-700">Pays *</label>
        ...
        <!-- Phone -->
        <div>
          <label for="edit_phone" class="block mb-1 text-sm font-medium text-gray-700">Téléphone *</label>
