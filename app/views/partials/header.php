...
$metaDescription = isset($metaDescription) ? $metaDescription : 'Découvrez la gamme complète de machines à coudre, surjeteuses et accessoires Singer. Livraison offerte à partir de 300€.';

// Default meta keywords if none are provided
$metaKeywords = isset($metaKeywords) ? $metaKeywords : 'Singer, machine à coudre, surjeteuse, couture, broderie';
...
<body class="bg-white">
  ...
  <div class="singer-red text-white text-center text-sm font-medium py-1.5">
    <div class="site-container">Livraison offerte à partir de 300€ d'achat !</div>
  </div>
            ...
            <?php if (!empty($item['submenu'])): ?>
              ...
              <div id="submenu-<?= $index ?>" class="hidden">
                ...
                <div class="mt-6 space-y-4">
                  <a href="<?= $item['url'] ?>" class="flex items-center text-sm singer-red-text">
                    Nos bestsellers <i class="ml-auto fas fa-arrow-right"></i>
                  </a>
                  <a href="<?= $item['url'] ?>?level=debutant" class="flex items-center text-sm singer-red-text">
                    Recherche par niveau <i class="ml-auto fas fa-arrow-right"></i>
                  </a>
                </div>
              </div>
            <?php endif; ?>
