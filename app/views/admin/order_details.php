  ...
  <div class="site-container">
    <div class="mb-6">
      <div class="flex items-center mb-2">
        <a href="/admin/orders" class="mr-2 text-sm text-gray-600 hover:text-primary">
        ...
        <div class="sticky p-4 bg-white border border-gray-200 rounded-lg shadow-sm top-20">
          ...
          <div class="mb-4">
            <form action="/admin/update-order-status" method="POST">
              ...
              <button type="submit" class="w-full py-2 text-white transition rounded-md bg-primary hover:bg-primary-hover">
          ...
          <div class="pt-4 mt-4 border-t border-gray-200">
            <a href="#" onclick="window.print()" class="flex items-center mb-2 text-sm text-gray-700 hover:text-primary">
              <i class="w-5 mr-2 text-center fas fa-print"></i>
              <?= __('admin.print_order') ?>
            </a>
            <a href="mailto:<?= htmlspecialchars($order['email']) ?>" class="flex items-center text-sm text-gray-700 hover:text-primary">
      ...
      <div class="md:col-span-3">
        <?php if (!$order): ?>
          <div class="p-6 text-center bg-white border border-gray-200 rounded-lg">
            ...
            <a href="/admin/orders" class="inline-block px-4 py-2 mt-4 text-sm text-white transition rounded-full bg-primary hover:bg-primary-hover">
              <?= __('admin.order_list') ?>
            </a>
          </div>
        <?php else: ?>
